  ...
  return (
    <section className="border-t border-white/10 bg-surface">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <h2 className="font-display font-display-italic text-4xl text-paper">
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {DELIVERY_CITIES.map((city) => (
            <div
              key={city}
              className="rounded-sm border border-white/10 bg-surface-light px-4 py-3 text-center text-sm font-bold text-paper/80"
            >
              {city}
            </div>
          ))}
