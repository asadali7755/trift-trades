    ...
    <section className="border-y border-white/10 bg-surface">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div className="order-2 flex flex-col gap-4 lg:order-1">
          <h2 className="font-display font-display-italic text-4xl text-paper sm:text-5xl">
        ...
        <div className="order-1 mx-auto aspect-[9/16] max-h-[480px] w-full max-w-xs overflow-hidden rounded-sm bg-ink lg:order-2">
          <video
