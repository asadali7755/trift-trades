        ...
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-x-6 gap-y-2">
            <a
              ...
              className="inline-block border-b border-accent pb-1 text-xs font-bold uppercase tracking-widest text-accent"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 border-b border-accent pb-1 text-xs font-bold uppercase tracking-widest text-accent"
            >
